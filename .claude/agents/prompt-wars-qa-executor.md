...
- Use the right runner: Jest (jest-expo) for app code, Deno for Edge Functions in `supabase/functions/_tests/`; remote integration tests are gated on `PROMPT_WARS_REMOTE_FUNCTION_TESTS=1`.
