...
export const ARENA_TIPS: readonly string[] = [
  ...
  'The judge scores clarity, originality, specificity, theme fit, character consistency and dramatic potential.',
  "Character consistency is part of the score, so write in your fighter's voice, not only about the theme.",
  ...
  'Strength affects damage, Focus affects scoring, and Agility can reduce incoming damage.',
  'Every prompt is moderated before the judge reads it.',
  'Return to Arena saves your draft, and forfeiting or canceling a battle is free.',
  'Your battle theme is revealed after matching.',
