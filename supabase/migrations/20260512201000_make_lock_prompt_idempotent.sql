-- Make prompt submission idempotent for client retries and double taps.
-- A successful first submit moves bot battles to resolving immediately; a retry
-- should return the existing prompt id instead of failing the status check.
